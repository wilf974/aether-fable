...
| **Driver mobilité** | **RÉSOLU PAR ÉLIMINATION → CONTINGENCE (H3)** : ni l'écologie (H1 food réfuté), ni la politique apprise (H2 réfuté — politiques village/mobile indistinguables, OBS V3.0). Même monde, mêmes politiques → village/mobile = réalisation stochastique du goulot démographique (contingence de Gould). Voir `2026-06-02-finding-v8c3-h2-policy-refuted-mobility-contingent.md` | ✅ H1+H2 réfutés instrumentalement ; reste à *caractériser* la contingence (réplications) |
